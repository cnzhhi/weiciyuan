...
import me.ivps.android.myweibo.dao.emotions.EmotionsDao;
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (values.length > 0) {
                ...
                Notification.Builder builder = new Notification.Builder(
                        ...
                        .setContentTitle(getString(R.string.weibo_emotions))
                        .setContentText(
                                getString(R.string.background_downloading))
                        .setProgress(size, data, false).setNumber(size - data)
                        .setSmallIcon(R.drawable.download_light);
                notification = builder.getNotification();
