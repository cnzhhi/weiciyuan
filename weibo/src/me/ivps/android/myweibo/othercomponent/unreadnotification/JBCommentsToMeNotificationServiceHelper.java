 ...
 */
@Deprecated
public class JBCommentsToMeNotificationServiceHelper extends
    ...
    private void buildNotification() {
        ...
        builder.setContentTitle(String.format(GlobalContext.getInstance()
                .getString(R.string.new_comments), String.valueOf(count)));
        ...
        Intent intent = WriteReplyToCommentActivity.newIntentFromNotification(
        ...
        if (count > 1) {
            ...
            Intent nextIntent = new Intent(
                    JBCommentsToMeNotificationServiceHelper.this,
                    JBCommentsToMeNotificationServiceHelper.class);
            nextIntent.putExtra(NotificationServiceHelper.ACCOUNT_ARG,
                    accountBean);
            nextIntent.putExtra(NotificationServiceHelper.COMMENTS_TO_ME_ARG,
                    data);
            ...
            PendingIntent retrySendIntent = PendingIntent.getService(
                    JBCommentsToMeNotificationServiceHelper.this, 0,
        ...
        notificationManager.notify(getCommentsToMeNotificationId(accountBean),
                builder.build());
    }
