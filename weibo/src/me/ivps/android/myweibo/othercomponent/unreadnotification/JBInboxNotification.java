...
public class JBInboxNotification {
    ...
    public JBInboxNotification(Context context, AccountBean accountBean,
    ...
    public Notification get() {
        ...
        if (comment != null) {
            for (CommentBean c : comment.getItemList()) {
                inboxStyle.addLine(c.getUser().getScreen_name() + ":"
                        + c.getText());
            }
        }
        ...
        if (repost != null) {
            for (MessageBean m : repost.getItemList()) {
                inboxStyle.addLine(m.getUser().getScreen_name() + ":"
                        + m.getText());
            }
        }
