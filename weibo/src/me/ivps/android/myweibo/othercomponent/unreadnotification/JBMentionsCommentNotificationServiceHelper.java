 ...
 */
@Deprecated
public class JBMentionsCommentNotificationServiceHelper extends
    ...
    private void buildNotification() {
        ...
        builder.setContentTitle(String.format(GlobalContext.getInstance()
                .getString(R.string.new_mentions_comment), String
                .valueOf(count)));
        ...
        IntentFilter intentFilter = new IntentFilter(
                RESET_UNREAD_MENTIONS_COMMENT_ACTION);
        ...
        if (count > 1) {
            Intent nextIntent = new Intent(
                    JBMentionsCommentNotificationServiceHelper.this,
            ...
            PendingIntent retrySendIntent = PendingIntent.getService(
                    JBMentionsCommentNotificationServiceHelper.this, 0,
        ...
        notificationManager.notify(
                getMentionsCommentNotificationId(accountBean), builder.build());
    }
