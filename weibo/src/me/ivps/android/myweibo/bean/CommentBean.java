...
public class CommentBean extends ItemBean implements Parcelable {
    ...
    public static final Parcelable.Creator<CommentBean> CREATOR = new Parcelable.Creator<CommentBean>() {
        public CommentBean createFromParcel(Parcel in) {
            ...
            commentBean.user = in.readParcelable(UserBean.class
                    .getClassLoader());
            commentBean.status = in.readParcelable(MessageBean.class
                    .getClassLoader());
            commentBean.reply_comment = in.readParcelable(CommentBean.class
                    .getClassLoader());
