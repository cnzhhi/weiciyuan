...
public class TimeLinePosition implements Serializable {
    ...
    // Fragment contain ListView, when Fragment is invisible (user dont open
    // Fragment), ListView children count is zero, getFirstVisiblePosition
    // return zero
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder()
                .append("first item id :").append(firstItemId).append("; top=")
                .append(top);
