package me.ivps.android.myweibo.bean;
...
import me.ivps.android.myweibo.support.utils.ObjectToStringUtility;
...
public class MessageListBean extends ListBean<MessageBean, MessageListBean>
    ...
    public void addOldData(MessageListBean oldValue) {
        if (oldValue != null && oldValue.getSize() > 1) {
            getItemList().addAll(
                    oldValue.getItemList().subList(1, oldValue.getSize()));
            setTotal_number(oldValue.getTotal_number());
        }
    }
    
    public void addMiddleData(int position, MessageListBean middleValue,
        ...
        List<MessageBean> middleData = middleValue.getItemList().subList(1,
                middleValue.getSize());
