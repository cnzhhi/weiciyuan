...
import me.ivps.android.myweibo.othercomponent.ConnectionChangeReceiver;
import me.ivps.android.myweibo.othercomponent.MusicReceiver;
import me.ivps.android.myweibo.support.database.AccountDBTask;
import me.ivps.android.myweibo.support.database.DatabaseManager;
...
import me.ivps.android.myweibo.ui.dm.DMUserListFragment;
import me.ivps.android.myweibo.ui.maintimeline.FriendsTimeLineFragment;
import me.ivps.android.myweibo.ui.search.SearchMainParentFragment;
import me.ivps.android.myweibo.ui.send.WriteWeiboActivity;
import me.ivps.android.myweibo.ui.userinfo.MyFavListFragment;
import me.ivps.android.myweibo.ui.userinfo.UserInfoActivity;
import me.ivps.android.myweibo.ui.userinfo.UserInfoFragment;
...
public class MainTimeLineActivity extends MainTimeLineParentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            accountBean = savedInstanceState
                    .getParcelable(BundleArgsConstants.ACCOUNT_EXTRA);
        }
        else {
    ...
    private void readClipboard() {
        ...
        if (item != null) {
            ...
            if (a && b) {
                OpenWeiboAccountLinkDialog dialog = OpenWeiboAccountLinkDialog
                        .newInstance(url);
    ...
    private class NewMsgInterruptBroadcastReceiver extends
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // int unreadCount = (mentionsWeibo != null ?
            // mentionsWeibo.getSize() : 0) + (
            // mentionsComment != null ? mentionsComment.getSize() : 0) + (
            // commentsToMe != null ? commentsToMe
            // .getSize() : 0);
            // String tip =
            // String.format(context.getString(R.string.you_have_new_unread_count),
