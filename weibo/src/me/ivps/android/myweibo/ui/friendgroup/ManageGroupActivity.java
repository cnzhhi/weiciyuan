...
import me.ivps.android.myweibo.dao.group.CreateGroupDao;
import me.ivps.android.myweibo.dao.group.DestroyGroupDao;
import me.ivps.android.myweibo.dao.group.UpdateGroupNameDao;
...
import me.ivps.android.myweibo.ui.preference.SettingActivity;
    ...
    public static class ManageGroupFragment extends ListFragment {
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            getListView().setMultiChoiceModeListener(
                    new GroupMultiChoiceModeListener());
        ...
        public void addGroup(String groupName) {
            new CreateGroupTask(GlobalContext.getInstance().getSpecialToken(),
                    groupName)
                    .executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
        }
        
        public void modifyGroupName(String idstr, String groupName) {
            new ModifyGroupNameTask(GlobalContext.getInstance()
                    .getSpecialToken(), idstr, groupName)
                    .executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
        }
        
        public void removeGroup(List<String> groupNames) {
            new RemoveGroupTask(GlobalContext.getInstance().getSpecialToken(),
                    groupNames)
                    .executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
        }
        ...
        class GroupAdapter extends BaseAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                View view = getActivity().getLayoutInflater().inflate(
                        R.layout.managegroupactivity_list_item_layout, parent,
                        false);
        ...
        class GroupMultiChoiceModeListener implements
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                mode.getMenuInflater().inflate(
                        R.menu.contextual_menu_managegroupfragment, menu);
                ...
                switch (item.getItemId()) {
                    case R.id.menu_modify_group_name:
                        ...
                        for (int i = 0; i < positions.size(); i++) {
                            if (positions.get(positions.keyAt(i))) {
                                oriName = group.getLists()
                                        .get(positions.keyAt(i)).getName();
                                checkedIdstrs.add(group.getLists()
                                        .get(positions.keyAt(i)).getIdstr());
                            }
                        }
                        ModifyGroupDialog modifyGroupDialog = new ModifyGroupDialog(
                                oriName, checkedIdstrs.get(0));
                        modifyGroupDialog.setTargetFragment(
                                ManageGroupFragment.this, 0);
                    ...
                    case R.id.menu_remove:
                        ...
                        RemoveGroupDialog removeGroupDialog = new RemoveGroupDialog(
                                checkedIdstrs);
                        removeGroupDialog.setTargetFragment(
                                ManageGroupFragment.this, 0);
        ...
        class CreateGroupTask extends MyAsyncTask<Void, Void, GroupBean> {
            ...
            protected void onPostExecute(GroupBean groupBean) {
                ...
                if (Utility.isAllNotNull(groupBean)) {
                    new RefreshGroupTask(token)
                            .executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
        }
        
        class RefreshGroupTask extends
            ...
            protected void onPostExecute(GroupListBean groupListBean) {
                ...
                GroupDBTask.update(groupListBean, GlobalContext.getInstance()
                        .getCurrentAccountId());
        ...
        class ModifyGroupNameTask extends MyAsyncTask<Void, Void, GroupBean> {
            ...
            public ModifyGroupNameTask(String token, String groupIdstr,
                    String name) {
                this.token = token;
            ...
            protected GroupBean doInBackground(Void... params) {
                try {
                    ...
                    return new UpdateGroupNameDao(token, groupIdstr, name)
                            .update();
                }
                catch (WeiboException e) {
                    e.printStackTrace();
