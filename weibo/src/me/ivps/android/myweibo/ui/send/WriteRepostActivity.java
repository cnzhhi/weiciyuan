...
public class WriteRepostActivity extends AbstractWriteActivity<MessageBean> {
    ...
    private void handleDraftOperation(Intent intent) {
        ...
        if (msg.getRetweeted_status() != null) {
            getEditTextView().setHint(
                    "//@"
                            + msg.getRetweeted_status().getUser()
                                    .getScreen_name() + "："
    ...
    public static Intent startBecauseSendFailed(Context context,
            AccountBean accountBean, String content, MessageBean oriMsg,
    ...
    private void handleFailedOperation(Intent intent) {
        ...
        repostDraftBean = (RepostDraftBean) intent
                .getParcelableExtra("repostDraftBean");
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            repostDraftBean = (RepostDraftBean) savedInstanceState
                    .getParcelable("repostDraftBean");
        }
    }
    ...
    protected boolean canShowSaveDraftDialog() {
        ...
        else if (!repostDraftBean.getContent().equals(
    ...
    public void saveToDraft() {
        if (!TextUtils.isEmpty(getEditTextView().getText().toString())) {
            DraftDBManager.getInstance().insertRepost(
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater()
                .inflate(R.menu.actionbar_menu_repostnewactivity, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_enable_ori_comment:
                if (menuEnableOriComment != null
                        && menuEnableOriComment.isChecked()) {
                    menuEnableOriComment.setChecked(false);
                }
                else if (menuEnableOriComment != null
                        && !menuEnableOriComment.isChecked()) {
                    menuEnableOriComment.setChecked(true);
                }
                break;
            case R.id.menu_at:
                Intent intent = new Intent(WriteRepostActivity.this,
    ...
    protected void send() {
        if (canSend()) {
            ...
            boolean oriComment = (menuEnableOriComment != null && menuEnableOriComment
                    .isChecked());
            String is_comment = "";
