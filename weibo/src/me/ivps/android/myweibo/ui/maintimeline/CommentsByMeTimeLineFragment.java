...
import me.ivps.android.myweibo.ui.loader.CommentsByMeDBLoader;
import me.ivps.android.myweibo.ui.loader.CommentsByMeMsgLoader;
...
public class CommentsByMeTimeLineFragment extends
    ...
    private static final String ARGUMENTS_ACCOUNT_EXTRA = CommentsByMeTimeLineFragment.class
            .getName() + ":account_extra";
    private static final String ARGUMENTS_USER_EXTRA = CommentsByMeTimeLineFragment.class
            .getName() + ":userBean_extra";
    private static final String ARGUMENTS_TOKEN_EXTRA = CommentsByMeTimeLineFragment.class
            .getName() + ":token_extra";
    private static final String ARGUMENTS_DATA_EXTRA = CommentsByMeTimeLineFragment.class
            .getName() + ":msg_extra";
    private static final String ARGUMENTS_TIMELINE_POSITION_EXTRA = CommentsByMeTimeLineFragment.class
    ...
    public static CommentsByMeTimeLineFragment newInstance(
