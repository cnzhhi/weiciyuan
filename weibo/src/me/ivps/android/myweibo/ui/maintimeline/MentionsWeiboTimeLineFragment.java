...
import me.ivps.android.myweibo.ui.loader.MentionsWeiboMsgLoader;
import me.ivps.android.myweibo.ui.loader.MentionsWeiboTimeDBLoader;
...
/**
 * User: qii Date: 12-7-29 Weibo repost message timeline
 */
public class MentionsWeiboTimeLineFragment extends
        AbstractMessageTimeLineFragment<MessageListBean> {
    
    private static final String ARGUMENTS_ACCOUNT_EXTRA = MentionsWeiboTimeLineFragment.class
            .getName() + ":account_extra";
    private static final String ARGUMENTS_USER_EXTRA = MentionsWeiboTimeLineFragment.class
            .getName() + ":userBean_extra";
    private static final String ARGUMENTS_TOKEN_EXTRA = MentionsWeiboTimeLineFragment.class
            .getName() + ":token_extra";
    private static final String ARGUMENTS_DATA_EXTRA = MentionsWeiboTimeLineFragment.class
            .getName() + ":msg_extra";
    private static final String ARGUMENTS_TIMELINE_POSITION_EXTRA = MentionsWeiboTimeLineFragment.class
    ...
    public static MentionsWeiboTimeLineFragment newInstance(
    ...
    private void addNewDataAndRememberPosition(final MessageListBean newValue) {
        ...
        if (isDataSourceEmpty) {
            ...
            newMsgTipBar
                    .setValue(MentionsWeiboTimeLineFragment.this.timeLinePosition.newMsgIds);
        ...
        showUIUnreadCount(MentionsWeiboTimeLineFragment.this.timeLinePosition.newMsgIds
                .size());
        MentionWeiboTimeLineDBTask
                .asyncReplace(getList(), accountBean.getUid());
    }
    ...
    protected void middleMsgLoaderSuccessCallback(int position,
        ...
        if (getActivity() != null && newValue != null && newValue.getSize() > 0) {
            ...
            getAdapter().notifyDataSetChanged();
            MentionWeiboTimeLineDBTask.asyncReplace(getList(),
                    accountBean.getUid());
        }
    }
    ...
    private LoaderManager.LoaderCallbacks<MentionTimeLineData> dbCallback = new LoaderManager.LoaderCallbacks<MentionTimeLineData>() {
        ...
        public Loader<MentionTimeLineData> onCreateLoader(int id, Bundle args) {
            ...
            return new MentionsWeiboTimeDBLoader(getActivity(), GlobalContext
                    .getInstance().getCurrentAccountId());
        }
        
        @Override
        public void onLoadFinished(Loader<MentionTimeLineData> loader,
                MentionTimeLineData result) {
    ...
    protected Loader<AsyncTaskLoaderResult<MessageListBean>> onCreateNewMsgLoader(
        ...
        return new MentionsWeiboMsgLoader(getActivity(), accountId, token,
                sinceId, null);
    }
    ...
    private AppNotificationCenter.Callback callback = new AppNotificationCenter.Callback() {
        ...
        @Override
        public void unreadMentionsChanged(AccountBean account,
