...
import me.ivps.android.myweibo.othercomponent.unreadnotification.NotificationServiceHelper;
...
import me.ivps.android.myweibo.ui.loader.MentionsCommentDBLoader;
import me.ivps.android.myweibo.ui.loader.MentionsCommentMsgLoader;
import me.ivps.android.myweibo.ui.main.MainTimeLineActivity;
import me.ivps.android.myweibo.ui.main.MentionsTimeLine;
 ...
 */
public class MentionsCommentTimeLineFragment extends
        AbstractTimeLineFragment<CommentListBean> implements IRemoveItem {
    
    private static final String ARGUMENTS_ACCOUNT_EXTRA = MentionsCommentTimeLineFragment.class
            .getName() + ":account_extra";
    private static final String ARGUMENTS_USER_EXTRA = MentionsCommentTimeLineFragment.class
            .getName() + ":userBean_extra";
    private static final String ARGUMENTS_TOKEN_EXTRA = MentionsCommentTimeLineFragment.class
            .getName() + ":token_extra";
    private static final String ARGUMENTS_DATA_EXTRA = MentionsCommentTimeLineFragment.class
            .getName() + ":msg_extra";
    private static final String ARGUMENTS_TIMELINE_POSITION_EXTRA = MentionsCommentTimeLineFragment.class
    ...
    public static MentionsCommentTimeLineFragment newInstance(
    ...
    private void setListViewPositionFromPositionsCache() {
        Utility.setListViewAdapterPosition(getListView(),
                timeLinePosition != null ? timeLinePosition.getPosition(bean)
                        : 0, timeLinePosition != null ? timeLinePosition.top
                        : 0, new Runnable() {
                    @Override
                    public void run() {
    ...
    protected void listViewItemClick(AdapterView parent, View view,
            int position, long id) {
        CommentFloatingMenu menu = new CommentFloatingMenu(getList().getItem(
                position));
    ...
    protected void newMsgLoaderSuccessCallback(CommentListBean newValue,
        ...
        notificationManager.cancel(NotificationServiceHelper
                .getMentionsCommentNotificationId(GlobalContext.getInstance()
                        .getAccountBean()));
    }
    ...
    private void addNewDataAndRememberPosition(final CommentListBean newValue) {
        ...
        if (isDataSourceEmpty) {
            ...
            newMsgTipBar
                    .setValue(MentionsCommentTimeLineFragment.this.timeLinePosition.newMsgIds);
        ...
        showUIUnreadCount(MentionsCommentTimeLineFragment.this.timeLinePosition.newMsgIds
                .size());
        MentionCommentsTimeLineDBTask.asyncReplace(getList(),
                accountBean.getUid());
    }
    ...
    private LoaderManager.LoaderCallbacks<CommentTimeLineData> dbCallback = new LoaderManager.LoaderCallbacks<CommentTimeLineData>() {
        ...
        public Loader<CommentTimeLineData> onCreateLoader(int id, Bundle args) {
            ...
            return new MentionsCommentDBLoader(getActivity(), GlobalContext
    ...
    protected Loader<AsyncTaskLoaderResult<CommentListBean>> onCreateNewMsgLoader(
        ...
        return new MentionsCommentMsgLoader(getActivity(), accountId, token,
                sinceId, null);
    }
    ...
    private AppNotificationCenter.Callback callback = new AppNotificationCenter.Callback() {
        @Override
        public void unreadMentionsCommentChanged(AccountBean account,
            ...
            clearUnreadMentions(AppNotificationCenter.getInstance()
