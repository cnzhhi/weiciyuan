...
import me.ivps.android.myweibo.dao.group.GroupListDao;
...
import me.ivps.android.myweibo.ui.friendgroup.ManageGroupActivity;
...
public class ManageGroupDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View customTitle = getActivity().getLayoutInflater().inflate(
                R.layout.managegroupdialog_title_layout, null);
        
        ImageView setting = (ImageView) customTitle
                .findViewById(R.id.title_button);
        
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),
                        ManageGroupActivity.class));
            }
        });
        
        builder.setMultiChoiceItems(valueArray, selectedArray,
                new DialogMultiChoiceClickListener())
                .setPositiveButton(getString(R.string.save),
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                ModifyGroupMemberTask modifyGroupMemberTask = new ModifyGroupMemberTask(
                                        uid, addList, removeList);
    ...
    class DialogMultiChoiceClickListener implements
    ...
    class Task extends MyAsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            GroupListDao dao = new GroupListDao(GlobalContext.getInstance()
                    .getSpecialToken(), uid);
            try {
                return dao.getInfo();
            }
                ...
                for (String id : strings) {
                    for (int i = 0; i < length; i++) {
                        if (group.getLists().get(i).getIdstr().equals(id)) {
                            ...
                            ((AlertDialog) getDialog()).getListView()
    ...
    private static class ModifyGroupMemberTask extends
        ...
        public ModifyGroupMemberTask(String uid, List<String> add,
                List<String> remove) {
            this.uid = uid;
            this.add = add;
            this.remove = remove;
        ...
        protected Void doInBackground(Void... params) {
            ModifyGroupMemberDao dao = new ModifyGroupMemberDao(GlobalContext
                    .getInstance().getSpecialToken(), uid);
            for (String id : add) {
                try {
                    dao.add(id);
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(
                    ...
                    GlobalContext.getInstance().getString(
                            R.string.modify_successfully), Toast.LENGTH_SHORT)
                    .show();
        }
    }
}