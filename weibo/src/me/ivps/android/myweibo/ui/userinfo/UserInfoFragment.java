...
import me.ivps.android.myweibo.bean.android.MyStatusTimeLineData;
import me.ivps.android.myweibo.bean.android.TimeLinePosition;
import me.ivps.android.myweibo.dao.show.ShowUserDao;
import me.ivps.android.myweibo.dao.topic.UserTopicListDao;
...
import me.ivps.android.myweibo.support.database.MyStatusDBTask;
import me.ivps.android.myweibo.support.database.TopicDBTask;
...
import me.ivps.android.myweibo.support.utils.ViewUtility;
...
import me.ivps.android.myweibo.ui.loader.StatusesByIdLoader;
import me.ivps.android.myweibo.ui.main.LeftMenuFragment;
import me.ivps.android.myweibo.ui.main.MainTimeLineActivity;
import me.ivps.android.myweibo.ui.topic.UserTopicListActivity;
 ...
 */
public class UserInfoFragment extends
        AbstractMessageTimeLineFragment<MessageListBean> implements
        MainTimeLineActivity.ScrollableListFragment, Animator.AnimatorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        header = inflater.inflate(R.layout.newuserinfofragment_header_layout,
                getListView(), false);
        getListView().addHeaderView(header);
        
        footerView.setVisibility(View.GONE);
        
        progressFooter = inflater.inflate(
                R.layout.newuserinfofragment_progress_footer, getListView(),
                false);
        progressFooter.setVisibility(View.GONE);
        getListView().addFooterView(progressFooter);
        
        moreFooter = inflater.inflate(R.layout.newuserinfofragment_more_footer,
                getListView(), false);
        ...
        headerFirst = inflater.inflate(
                R.layout.newuserinfofragment_header_viewpager_first_layout,
                null, false);
        headerSecond = inflater.inflate(
                R.layout.newuserinfofragment_header_viewpager_second_layout,
                null, false);
        headerThird = inflater.inflate(
                R.layout.newuserinfofragment_header_viewpager_third_layout,
                null, false);
        ...
        verifiedReason = ViewUtility.findViewById(headerThird,
                R.id.verified_reason);
        ...
        View weiboCountLayout = ViewUtility.findViewById(header,
                R.id.weibo_count_layout);
        View friendsCountLayout = ViewUtility.findViewById(header,
                R.id.friends_count_layout);
        View fansCountLayout = ViewUtility.findViewById(header,
                R.id.fans_count_layout);
        View topicCountLayout = ViewUtility.findViewById(header,
                R.id.topics_count_layout);
        
        weiboCountLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = UserTimeLineActivity.newIntent(GlobalContext
                        .getInstance().getSpecialToken(), userBean);
        ...
        friendsCountLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = FriendListActivity.newIntent(GlobalContext
                        .getInstance().getSpecialToken(), userBean);
                startActivity(intent);
            }
        });
        ...
        fansCountLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = FanListActivity.newIntent(GlobalContext
                        .getInstance().getSpecialToken(), userBean);
                startActivity(intent);
            }
        });
        ...
        topicCountLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = UserTopicListActivity.newIntent(userBean,
                        topicList);
                startActivity(intent);
            }
        });
        ...
        if (!isOpenedFromMainPage()) {
            SwipeFrameLayout swipeFrameLayout = new SwipeFrameLayout(
                    getActivity());
            swipeFrameLayout.addView(result, new ViewGroup.LayoutParams(
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getPullToRefreshListView().getRefreshableView().setOverScrollMode(
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        if (Math.abs(rawX - event.getRawX()) > ViewConfiguration
                                .get(getActivity()).getScaledTouchSlop()) {
                            viewPager.getParent()
    ...
    private void displayBasicInfo() {
        ...
        friendsCount.setText(Utility.convertStateNumberToString(getActivity(),
                userBean.getFriends_count()));
        fansCount.setText(Utility.convertStateNumberToString(getActivity(),
                userBean.getFollowers_count()));
        weiboCount.setText(Utility.convertStateNumberToString(getActivity(),
                userBean.getStatuses_count()));
        ...
        avatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String path = FileManager.getFilePathFromUrl(
                        userBean.getAvatar_large(),
                        FileLocationMethod.avatar_large);
                if (!ImageUtility.isThisBitmapCanRead(path)) {
                    
                    path = FileManager.getFilePathFromUrl(
                ...
                UserAvatarDialog dialog = UserAvatarDialog.newInstance(path,
                        rect);
    ...
    private void displayCoverPicture() {
        ...
        final int width = Utility
                .getMaxLeftWidthOrHeightImageViewCanRead(height);
        ...
        TranslateAnimation animation = new TranslateAnimation(
                ...
                Animation.RELATIVE_TO_SELF, -100f, Animation.RELATIVE_TO_SELF,
                0f);
        animation.setDuration(3000);
        animation.setInterpolator(new DecelerateInterpolator());
        ArrayList<Animation> animationArray = new ArrayList<Animation>();
        animationArray.add(animation);
        TimeLineBitmapDownloader.getInstance().display(imageViewArrayList,
                width, height, picPath, FileLocationMethod.cover,
                animationArray);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if ((getActivity() instanceof MainTimeLineActivity)
                && (((MainTimeLineActivity) getActivity()).getMenuFragment())
                        .getCurrentIndex() == LeftMenuFragment.PROFILE_INDEX) {
    ...
    private boolean isMyself() {
        ...
        if (!TextUtils.isEmpty(userBean.getId())) {
            return userBean.getId().equals(
                    GlobalContext.getInstance().getCurrentAccountId());
        }
        
        if (!TextUtils.isEmpty(userBean.getScreen_name())) {
            return userBean.getScreen_name().equals(
                    GlobalContext.getInstance().getCurrentAccountName());
        }
    ...
    protected Loader<AsyncTaskLoaderResult<MessageListBean>> onCreateNewMsgLoader(
        ...
        return new StatusesByIdLoader(getActivity(), uid, screenName, token,
                sinceId, null, LIMITED_READ_MESSAGE_COUNT);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (isMyself() && isOpenedFromMainPage()) {
            inflater.inflate(
                    R.menu.actionbar_menu_newuserinfofragment_main_page, menu);
            MenuItem edit = menu.findItem(R.id.menu_edit);
            edit.setVisible(GlobalContext.getInstance().getAccountBean()
                    .isBlack_magic());
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_edit:
                if (isMyself() && isOpenedFromMainPage()) {
                    ...
                    intent.putExtra("userBean", GlobalContext.getInstance()
                            .getAccountBean().getInfo());
                    startActivity(intent);
                    return true;
                }
                else {
    ...
    private void startRefreshMenuAnimation() {
        ...
        View v = inflater.inflate(
                R.layout.newuserinfofragment_refresh_actionbar_view_layout,
                null);
    ...
    public void onPause() {
        super.onPause();
        if (!getActivity().isChangingConfigurations() && isMyself()
                && isOpenedFromMainPage()) {
            savePositionToDB();
        }
    }
    ...
    private void savePositionToDB() {
        ...
        MyStatusDBTask.asyncUpdatePosition(position, GlobalContext
    ...
    private class TopicListTask extends
        ...
        protected ArrayList<String> doInBackground(Void... params) {
            UserTopicListDao dao = new UserTopicListDao(GlobalContext
        ...
        protected void onPostExecute(ArrayList<String> result) {
            ...
            topicList = result;
            topicsCount.setText(Utility.convertStateNumberToString(
                    getActivity(), String.valueOf(result.size())));
    ...
    private class RefreshTask extends MyAsyncTask<Object, UserBean, UserBean> {
        ...
        protected UserBean doInBackground(Object... params) {
            if (!isCancelled()) {
                ...
                boolean haveName = !TextUtils
                        .isEmpty(userBean.getScreen_name());
                if (haveId) {
        ...
        protected void onPostExecute(UserBean o) {
            ...
            if (isMyself()) {
                ...
                AccountDBTask.asyncUpdateMyProfile(GlobalContext.getInstance()
                        .getAccountBean(), o);
            }
            getAdapter().notifyDataSetChanged();
            stopRefreshMenuAnimationIfPossible();
    ...
    private class DBCacheTask extends
            MyAsyncTask<Void, ArrayList<String>, MyStatusTimeLineData> {
