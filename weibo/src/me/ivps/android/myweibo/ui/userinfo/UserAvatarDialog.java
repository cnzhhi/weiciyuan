...
public class UserAvatarDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View content = getActivity().getLayoutInflater().inflate(
                R.layout.useravatardialog_layout, null);
        
        final ImageView avatar = ((ImageView) content
        ...
        content.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        final float scaleX = (float) ori.width()
                                / (float) avatar.getWidth();
                        final float scaleY = (float) ori.height()
                        ...
                        avatar.animate().translationX(0).translationY(0)
    ...
    private void animateClose(ImageView avatar, Rect ori) {
        ...
        avatar.animate().translationX(transX).translationY(transY)
                .scaleY(scaleY).scaleX(scaleX).alpha(0.7f).rotationY(0f)
                .setDuration(300).withEndAction(new Runnable() {
                    @Override
                    public void run() {
