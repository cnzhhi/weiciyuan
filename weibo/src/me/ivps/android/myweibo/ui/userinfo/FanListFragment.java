...
import me.ivps.android.myweibo.ui.actionmenu.MyFanSingleChoiceModeListener;
...
import me.ivps.android.myweibo.ui.loader.FanUserLoader;
...
public class FanListFragment extends AbstractFriendsFanListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getListView().setOnItemLongClickListener(
                new FanListOnItemLongClickListener());
    }
    ...
    private class FanListOnItemLongClickListener implements
                ...
                if (actionMode != null) {
                    ...
                    if (getCurrentUser().getId().equals(
                        ...
                        actionMode = getActivity().startActionMode(
                                new MyFanSingleChoiceModeListener(
                                        getListView(), getAdapter(),
                                        FanListFragment.this, bean.getUsers()
                                                .get(position - 1)));
                    }
                    else {
                        actionMode = getActivity().startActionMode(
    ...
    protected Loader<AsyncTaskLoaderResult<UserListBean>> onCreateNewUserLoader(
        ...
        return new FanUserLoader(getActivity(), token,
                getCurrentUser().getId(), cursor);
    }
