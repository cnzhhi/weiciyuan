...
import me.ivps.android.myweibo.ui.loader.SearchUserLoader;
...
public class SearchUserFragment extends AbstractUserListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            clearAndReplaceValue((UserListBean) savedInstanceState
                    .getParcelable("bean"));
    ...
    protected Loader<AsyncTaskLoaderResult<UserListBean>> onCreateNewUserLoader(
        ...
        String word = ((SearchMainParentFragment) getParentFragment())
                .getSearchWord();
        page = 1;
        return new SearchUserLoader(getActivity(), token, word,
                String.valueOf(page));
    }
