...
public class SearchMainActivity extends AbstractAppActivity {
    ...
    private void buildViewPager() {
        ...
        SearchTabPagerAdapter adapter = new SearchTabPagerAdapter(
    ...
    private void buildActionBarAndViewPagerTitles() {
        ...
        actionBar.addTab(actionBar.newTab().setText(getString(R.string.status))
                .setTabListener(tabListener));
        
        actionBar.addTab(actionBar.newTab().setText(getString(R.string.user))
                .setTabListener(tabListener));
    }
    ...
    private AbstractMessageTimeLineFragment getSearchStatusFragment() {
        return (AbstractMessageTimeLineFragment) getSupportFragmentManager()
