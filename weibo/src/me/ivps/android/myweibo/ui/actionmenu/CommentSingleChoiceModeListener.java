...
import me.ivps.android.myweibo.ui.browser.BrowserCommentActivity;
...
public class CommentSingleChoiceModeListener implements ActionMode.Callback {
    ...
    public CommentSingleChoiceModeListener(ListView listView,
            BaseAdapter adapter, Fragment fragment, CommentBean bean) {
    ...
    protected void buildMenu(ActionMode mode, Menu menu) {
        ...
        if (isMyComment || isCommentUnderMyStatus) {
            inflater.inflate(
                    R.menu.contextual_menu_fragment_comment_listview_myself,
                    menu);
        }
        else {
            inflater.inflate(R.menu.contextual_menu_fragment_comment_listview,
                    menu);
        }
