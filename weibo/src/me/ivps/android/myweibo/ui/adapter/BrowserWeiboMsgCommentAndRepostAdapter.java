...
import me.ivps.android.myweibo.support.lib.MyURLSpan;
...
import me.ivps.android.myweibo.ui.browser.BrowserWeiboMsgFragment;
...
public class BrowserWeiboMsgCommentAndRepostAdapter extends BaseAdapter {
    ...
    public BrowserWeiboMsgCommentAndRepostAdapter(Fragment fragment,
            ListView listView, List<CommentBean> commentListBean,
        ...
        this.checkedBG = ThemeUtility.getColor(fragment.getActivity(),
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            LongClickableLinkMovementMethod.getInstance().onTouchEvent(tv,
                    value, event);
            
            switch (event.getActionMasked()) {
                case MotionEvent.ACTION_DOWN:
                    MyURLSpan[] urlSpans = value.getSpans(0, value.length(),
                            MyURLSpan.class);
                    boolean find = false;
                    int findStart = 0;
                    int findEnd = 0;
                    ...
                    boolean hasActionMode = ((BrowserWeiboMsgFragment) fragment)
                            .hasActionMode();
                    ...
                    if (result) {
                        BackgroundColorSpan backgroundColorSpan = new BackgroundColorSpan(
                                ThemeUtility
                                        .getColor(R.attr.link_pressed_background_color));
    ...
    protected void buildAvatar(TimeLineAvatarImageView view, int position,
            final UserBean user) {
        ...
        if (postion >= 0 && postion < commentListBean.size()) {
            ...
            anim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    BrowserWeiboMsgCommentAndRepostAdapter.this
                            .notifyDataSetChanged();
                }
