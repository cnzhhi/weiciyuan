...
import me.ivps.android.myweibo.support.asyncdrawable.IPictureWorker;
import me.ivps.android.myweibo.support.asyncdrawable.IWeiciyuanDrawable;
import me.ivps.android.myweibo.support.asyncdrawable.PictureBitmapDrawable;
...
import me.ivps.android.myweibo.support.lib.ListViewMiddleMsgLoadingView;
import me.ivps.android.myweibo.support.lib.MyAsyncTask;
import me.ivps.android.myweibo.support.lib.TimeLineAvatarImageView;
import me.ivps.android.myweibo.support.lib.TimeTextView;
 ...
 */
public abstract class AbstractAppListAdapter<T extends ItemBean> extends
        BaseAdapter {
    ...
    public AbstractAppListAdapter(Fragment fragment, List<T> bean,
            ...
            public void onMovedToScrapHeap(View view) {
                ...
                for (Integer tag : tagIndexList) {
                    ...
                    if (holder != null) {
                        ...
                        drawable = holder.repost_content_pic.getImageView()
                                .getDrawable();
    ...
    public int getItemViewType(int position) {
        ...
        if (bean.get(position) == null
                || bean.get(position).isMiddleUnreadItem()) {
            return TYPE_MIDDLE;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null
            ...
            if (itemViewType != TYPE_MIDDLE) {
                ...
                convertView.setTag(R.drawable.ic_launcher
                ...
                tagIndexList.add(R.drawable.ic_launcher
        ...
        if (getItemViewType(position) != TYPE_MIDDLE) {
            ...
            if (savedCurrentMiddleLoadingViewPosition == position
    ...
    private View initMiddleLayout(ViewGroup parent) {
        ...
        convertView = inflater.inflate(
                R.layout.timeline_listview_item_middle_layout, parent, false);
    ...
    private View initSimpleLayout(ViewGroup parent) {
        View convertView;
        convertView = inflater.inflate(
                R.layout.timeline_listview_item_simple_layout, parent, false);
    ...
    private View initMylayout(ViewGroup parent) {
        ...
        if (SettingUtility.getEnableBigPic()) {
            convertView = inflater.inflate(
                    R.layout.timeline_listview_item_big_pic_layout, parent,
                    false);
        }
        else {
            convertView = inflater.inflate(
                    R.layout.timeline_listview_item_layout, parent, false);
        }
        return convertView;
    }
    ...
    private View initBigPicLayout(ViewGroup parent) {
        return inflater.inflate(R.layout.timeline_listview_item_big_pic_layout,
                parent, false);
    }
    ...
    private void configLayerType(ViewHolder holder) {
        ...
        if (View.LAYER_TYPE_SOFTWARE != currentWidgetLayerType) {
            ...
            if (holder.repost_content != null) {
                holder.repost_content.setLayerType(View.LAYER_TYPE_SOFTWARE,
                        null);
            }
            if (holder.time != null) {
            ...
            if (holder.comment_count != null) {
                holder.comment_count.setLayerType(View.LAYER_TYPE_SOFTWARE,
                        null);
            }
        }
    }
    ...
    protected void buildAvatar(IWeiciyuanDrawable view, int position,
            final UserBean user) {
    ...
    protected void buildPic(final MessageBean msg,
            final IWeiciyuanDrawable view, int position) {
        if (SettingUtility.isEnablePic()) {
            view.setVisibility(View.VISIBLE);
            view.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public void removeItem(final int postion) {
        if (postion >= 0 && postion < bean.size()) {
            ...
            Animation anim = AnimationUtils.loadAnimation(
                    ...
                    R.anim.account_delete_slide_out_right);
            ...
            if (positonInListView >= start && positonInListView <= end) {
                ...
                listView.getChildAt(positionInCurrentScreen + 1)
                        .startAnimation(anim);
                AppLogger.e("2");
            }
            else {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            boolean hasActionMode = ((AbstractTimeLineFragment) fragment)
                    .hasActionMode();
