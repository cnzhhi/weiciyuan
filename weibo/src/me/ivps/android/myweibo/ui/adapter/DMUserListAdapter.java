...
public class DMUserListAdapter extends BaseAdapter {
    ...
    public DMUserListAdapter(Fragment fragment, List<DMUserBean> bean,
            ListView listView) {
        this.bean = bean;
    ...
    private View initSimpleLayout(ViewGroup parent) {
        ...
        convertView = inflater.inflate(
                R.layout.dm_user_list_listview_item_layout, parent, false);
    ...
    private void buildUsername(DMViewHolder holder, UserBean user) {
        if (!TextUtils.isEmpty(user.getRemark())) {
            holder.username.setText(new StringBuilder(user.getScreen_name())
                    .append("(").append(user.getRemark()).append(")")
                    .toString());
        }
        else {
    ...
    protected void buildAvatar(ImageView view, int position, final UserBean user) {
        ...
        if (!TextUtils.isEmpty(image_url)) {
            ...
            commander.downloadAvatar(view, user,
