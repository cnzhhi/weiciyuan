...
public class DMConversationAdapter extends BaseAdapter {
    ...
    public DMConversationAdapter(Fragment fragment, List<DMBean> bean,
            ListView listView) {
        this.bean = bean;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null
                || convertView.getTag(R.drawable.ic_launcher
                        + getItemViewType(showPosition)) == null) {
            ...
            convertView.setTag(R.drawable.ic_launcher
                    + getItemViewType(showPosition), holder);
            convertView.setTag(R.string.listview_index_tag,
                    R.drawable.ic_launcher + getItemViewType(showPosition));
        }
        else {
            holder = (DMViewHolder) convertView.getTag(R.drawable.ic_launcher
                    + getItemViewType(showPosition));
        }
    ...
    private View initNormalSimpleLayout(ViewGroup parent) {
        ...
        convertView = inflater.inflate(
                R.layout.dmconversationadapter_item_normal_layout, parent,
                false);
    ...
    private View initMySimpleLayout(ViewGroup parent) {
        View convertView;
        convertView = inflater.inflate(
                R.layout.dmconversationadapter_item_myself_layout, parent,
                false);
        return convertView;
    }
    ...
    protected void buildAvatar(TimeLineAvatarImageView view, int position,
        ...
        if (!TextUtils.isEmpty(image_url)) {
            ...
            commander.downloadAvatar(view.getImageView(), user,
