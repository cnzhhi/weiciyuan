...
import me.ivps.android.myweibo.ui.loader.BrowserShareMsgLoader;
...
public class BrowserShareTimeLineActivity extends AbstractAppActivity {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    ...
                    .replace(android.R.id.content,
                            BrowserShareTimeLineFragment.newInstance(url))
                    .commit();
        }
        // 0.50 feature
    ...
    public static class BrowserShareTimeLineFragment extends
            AbstractMessageTimeLineFragment<ShareListBean> {
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            switch (getCurrentState(savedInstanceState)) {
                ...
                case ACTIVITY_DESTROY_AND_CREATE:
                    getList().addNewData(
                            (ShareListBean) savedInstanceState
                                    .getParcelable("bean"));
        ...
        protected void listViewItemClick(AdapterView parent, View view,
            ...
            startActivityForResult(BrowserWeiboMsgActivity.newIntent(getList()
                    .getItemList().get(position), GlobalContext.getInstance()
                    .getSpecialToken()), 0);
        }
        
        @Override
        protected void newMsgLoaderSuccessCallback(ShareListBean newValue,
                Bundle loaderArgs) {
        ...
        protected Loader<AsyncTaskLoaderResult<ShareListBean>> onCreateNewMsgLoader(
                int id, Bundle args) {
        ...
        protected Loader<AsyncTaskLoaderResult<ShareListBean>> onCreateOldMsgLoader(
                int id, Bundle args) {
            String token = GlobalContext.getInstance().getSpecialToken();
            String maxId = null;
            if (getList().getItemList().size() > 0) {
