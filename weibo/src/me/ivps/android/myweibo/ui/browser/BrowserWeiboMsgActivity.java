...
import me.ivps.android.myweibo.dao.show.ShowStatusDao;
...
import me.ivps.android.myweibo.ui.task.FavAsyncTask;
import me.ivps.android.myweibo.ui.task.UnFavAsyncTask;
...
public class BrowserWeiboMsgActivity extends AbstractAppActivity implements
        ...
        if (savedInstanceState != null) {
            ...
            if (ACTION_WITH_ID.equalsIgnoreCase(action)) {
                ...
                findViewById(android.R.id.content).setBackgroundDrawable(
                        ThemeUtility
                                .getDrawable(android.R.attr.windowBackground));
            }
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (getSupportFragmentManager().findFragmentByTag(
                        BrowserWeiboMsgFragment.class.getName()) == null) {
                    getSupportFragmentManager()
                            .beginTransaction()
                            .replace(android.R.id.content,
                                    BrowserWeiboMsgFragment.newInstance(msg),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (msg.getUser() != null
                && msg.getUser()
                        .getId()
                        .equals(GlobalContext.getInstance()
                                .getCurrentAccountId())) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_copy:
                ...
                cm.setPrimaryClip(ClipData.newPlainText("sinaweibo", getMsg()
                        .getText()));
                Toast.makeText(this, getString(R.string.copy_successfully),
                        Toast.LENGTH_SHORT).show();
                return true;
            case R.id.menu_fav:
                if (Utility.isTaskStopped(favTask)
                        && Utility.isTaskStopped(unFavTask)) {
            ...
            case R.id.menu_delete:
                RemoveWeiboMsgDialog dialog = new RemoveWeiboMsgDialog(
                        msg.getId());
    ...
    private void buildShareActionMenu() {
        Utility.setShareIntent(BrowserWeiboMsgActivity.this,
                shareActionProvider, msg);
    }
    ...
    private static class RefreshLoader extends
            AbstractAsyncNetRequestTaskLoader<MessageBean> {
        ...
        protected MessageBean loadData() throws WeiboException {
            return new ShowStatusDao(GlobalContext.getInstance()
                    .getSpecialToken(), msgId).getMsg();
        }
    }
    ...
    private LoaderManager.LoaderCallbacks<AsyncTaskLoaderResult<MessageBean>> refreshCallback = new LoaderManager.LoaderCallbacks<AsyncTaskLoaderResult<MessageBean>>() {
        @Override
        public Loader<AsyncTaskLoaderResult<MessageBean>> onCreateLoader(
                int id, Bundle args) {
        ...
        public void onLoadFinished(
                Loader<AsyncTaskLoaderResult<MessageBean>> loader,
