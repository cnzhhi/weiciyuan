...
import me.ivps.android.myweibo.dao.shorturl.ShareShortUrlCountDao;
...
public class BrowserWebActivity extends AbstractAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View title = getLayoutInflater().inflate(
                R.layout.browserwebactivity_title_layout, null);
    ...
    private class ShareCountTask extends MyAsyncTask<Void, Integer, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            int result = 0;
            try {
                result = new ShareShortUrlCountDao(GlobalContext.getInstance()
                        .getSpecialToken(), url).getCount();
            }
