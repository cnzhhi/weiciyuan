...
import me.ivps.android.myweibo.support.lib.sinasso.SsoHandler;
...
public class SSOActivity extends AbstractAppActivity {
    ...
    private static class SSOTask extends
            MyAsyncTask<String, UserBean, OAuthActivity.DBResult> {
        ...
        public SSOTask(SSOActivity ssoActivity, String token, String expiresIn) {
            this.sSOActivityWeakReference = new WeakReference<SSOActivity>(
                    ssoActivity);
            this.token = token;
        ...
        protected void onCancelled(OAuthActivity.DBResult dbResult) {
            ...
            if (e != null) {
                ...
                Toast.makeText(activity, R.string.you_cancel_login,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (error != null) {
            if (error.equals("access_denied")
                ...
                Toast.makeText(this, getString(R.string.login_failed) + error,
                        Toast.LENGTH_SHORT).show();
                finish();
            }
            return;
