...
public class AccountActivity extends AbstractAppActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ACTION_OPEN_FROM_APP_INNER_REFRESH_TOKEN.equals(action)) {
            ...
            AccountBean accountBean = getIntent().getParcelableExtra(
                    REFRESH_ACTION_EXTRA);
            Toast.makeText(
                    this,
                    String.format(
                            getString(R.string.account_token_has_expired),
                            accountBean.getUsernick()), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    private class AccountAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (!TextUtils.isEmpty(accountList.get(i).getAvatar_url())) {
                getBitmapDownloader().downloadAvatar(holder.avatar,
