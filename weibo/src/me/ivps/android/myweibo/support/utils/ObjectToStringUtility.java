...
import me.ivps.android.myweibo.bean.AtUserBean;
...
import me.ivps.android.myweibo.bean.NearbyStatusListBean;
import me.ivps.android.myweibo.bean.RepostListBean;
import me.ivps.android.myweibo.bean.SearchStatusListBean;
import me.ivps.android.myweibo.bean.SearchUserBean;
import me.ivps.android.myweibo.bean.ShareListBean;
import me.ivps.android.myweibo.bean.TagBean;
...
public class ObjectToStringUtility {
    ...
    public static String toString(AtUserBean user) {
        return String.format("nickname=%s,remark=%s", user.getNickname(),
                user.getRemark());
    }
    ...
    public static String toString(CommentBean comment) {
        ...
        return String.format("%s @%s:%s",
                TimeUtility.getListTime(comment.getMills()), username,
                comment.getText());
    }
    ...
    public static String toString(DMBean dm) {
        ...
        String username = (userBean != null ? userBean.getScreen_name()
                : "user is null");
        return String.format("%s @%s:%s",
                TimeUtility.getListTime(dm.getMills()), username, dm.getText());
    }
    ...
    public static String toString(MessageReCmtCountBean bean) {
        return "message id=" + bean.getId() + "," + "reposts="
                + bean.getReposts() + "," + "comments=" + bean.getComments();
    }
    ...
    public static String toString(SearchUserBean bean) {
        return "user id=" + bean.getUid() + "," + "name="
                + bean.getScreen_name();
    }
