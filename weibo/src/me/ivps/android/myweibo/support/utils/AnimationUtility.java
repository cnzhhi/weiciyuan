...
import me.ivps.android.myweibo.support.lib.LayerEnablingAnimatorListener;
...
public class AnimationUtility {
    ...
    public static void translateFragmentY(UserInfoFragment fragment, int from,
            int to, Animator.AnimatorListener animatorListener) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofInt(wrapper, "change",
                from, to);
        objectAnimator.setDuration(300);
        objectAnimator.setInterpolator(new DecelerateInterpolator());
        if (animatorListener != null) {
            objectAnimator.addListener(new LayerEnablingAnimatorListener(view,
                    animatorListener));
        }
    ...
    public static void forceConvertActivityToTranslucent(Activity activity) {
        ...
        if (Utility.isL()) {
            ...
            try {
                Class<?>[] declaredClasses = Activity.class
                        .getDeclaredClasses();
                Class<?> listener = null;
