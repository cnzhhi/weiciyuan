...
public class NotificationUtility {
    ...
    public static String getTicker(UnreadBean unreadBean,
            MessageListBean mentionsWeibo, CommentListBean mentionsComment,
        ...
        int mention = 0;
        if (SettingUtility.allowMentionToMe() && unreadMentionStatus > 0
                && mentionsWeibo != null) {
            int actualFetchedSize = mentionsWeibo.getSize();
            if (actualFetchedSize < Integer.valueOf(SettingUtility
                    .getMsgCount())) {
        ...
        if (mention > 0) {
            String txt = String.format(
                    GlobalContext.getInstance()
                            .getString(R.string.new_mentions), String
                            .valueOf(mention));
        ...
        if (SettingUtility.allowCommentToMe() && unreadCmt > 0
                && commentsToMe != null) {
            //
            ...
            if (cmt > 0) {
                String txt = String.format(GlobalContext.getInstance()
                        .getString(R.string.new_comments), String.valueOf(cmt));
                stringBuilder.append(txt);
            }
        }
