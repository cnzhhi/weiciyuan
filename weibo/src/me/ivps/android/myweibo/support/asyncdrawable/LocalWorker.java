...
public class LocalWorker extends AbstractWorker<String, Integer, Bitmap> {
    ...
    public LocalWorker(IWeiciyuanDrawable view, String url,
    ...
    protected Bitmap doInBackground(String... url) {
        ...
        switch (method) {
            ...
            case picture_bmiddle:
                if (!isMultiPictures) {
                    DisplayMetrics metrics = GlobalContext.getInstance()
                            .getDisplayMetrics();
    ...
    private void displayBitmap(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            imageView
                    .setImageDrawable(new ColorDrawable(DebugColor.READ_FAILED));
        }
    }
