...
import me.ivps.android.myweibo.support.database.DownloadPicturesDBTask;
...
public class DownloadFutureTask extends FutureTask<Boolean> {
    ...
    public static DownloadFutureTask newInstance(String url,
            FileLocationMethod method) {
        JobCallable jobCallable = new JobCallable(url, method);
        DownloadFutureTask downloadFutureTask = new DownloadFutureTask(
                jobCallable);
    ...
    private static class JobCallable implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            boolean result = ImageUtility.getBitmapFromNetWork(
                    actualDownloadUrl, filePath,
