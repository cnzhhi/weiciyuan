package me.ivps.android.myweibo.support.settinghelper;
...
public class SettingUtility {
    ...
    public static void switchToAnotherTheme() {
        ...
        switch (Integer.valueOf(value)) {
            case 1:
                SettingHelper.setEditor(getContext(), SettingActivity.THEME,
                        "2");
                break;
            case 2:
                SettingHelper.setEditor(getContext(), SettingActivity.THEME,
    ...
    public static int getHighPicMode() {
        String value = SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.LIST_HIGH_PIC_MODE, "2");
        return Integer.valueOf(value);
    }
    
    public static int getCommentRepostAvatar() {
        String value = SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.COMMENT_REPOST_AVATAR, "1");
        return Integer.valueOf(value);
    }
    ...
    public static int getListPicMode() {
        String value = SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.LIST_PIC_MODE, "1");
        return Integer.valueOf(value);
    }
    ...
    public static int getNotificationStyle() {
        String value = SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.JBNOTIFICATION_STYLE, "1");
    ...
    public static boolean getEnableFetchMSG() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.ENABLE_FETCH_MSG, false);
    }
    ...
    public static boolean allowVibrate() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.ENABLE_VIBRATE, false);
    }
    ...
    public static String getRingtone() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.ENABLE_RINGTONE, "");
    }
    ...
    public static boolean allowMentionToMe() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.ENABLE_MENTION_TO_ME, true);
    }
    
    public static boolean allowCommentToMe() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.ENABLE_COMMENT_TO_ME, true);
    }
    ...
    public static boolean isBlackMagicEnabled() {
        return SettingHelper.getSharedPreferences(getContext(), BLACK_MAGIC,
                false);
    }
    ...
    public static boolean isFollowingOrFanListFirstShow() {
        boolean result = SettingHelper.getSharedPreferences(getContext(),
                "is_following_or_fan_list_first_show", true);
        SettingHelper.setEditor(getContext(),
                "is_following_or_fan_list_first_show", false);
        return result;
    }
    
    public static boolean isClickToTopTipFirstShow() {
        boolean result = SettingHelper.getSharedPreferences(getContext(),
                CLICK_TO_TOP_TIP, true);
    ...
    public static boolean isFilterSinaAd() {
        return SettingHelper.getSharedPreferences(getContext(),
                SettingActivity.FILTER_SINA_AD, false);
    }
}
