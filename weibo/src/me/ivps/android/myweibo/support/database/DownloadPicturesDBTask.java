...
public class DownloadPicturesDBTask {
    ...
    public static String get(String url) {
        ...
        Cursor c = getRsd().query(DownloadPicturesTable.TABLE_NAME, null,
                DownloadPicturesTable.URL + "=?", new String[] { url }, null,
                null, null);
        ...
        if (!TextUtils.isEmpty(path)) {
            ContentValues cv = new ContentValues();
            cv.put(DownloadPicturesTable.TIME, System.currentTimeMillis());
            getWsd().update(DownloadPicturesTable.TABLE_NAME, cv,
                    DownloadPicturesTable.PATH + "=?", new String[] { path });
        }
        return path;
    }
    
    public static void remove(String url) {
        String sql = "delete from " + DownloadPicturesTable.TABLE_NAME
                + " where " + DownloadPicturesTable.URL + " = " + url;
        getWsd().execSQL(sql);
    }
    ...
    public static void trimToSize() {
        ...
        String sql = "select sum(" + DownloadPicturesTable.SIZE + ")"
                + " from " + DownloadPicturesTable.TABLE_NAME;
        ...
        Cursor c = getRsd()
                .query(DownloadPicturesTable.TABLE_NAME, null, null, null,
                        null, null,
        ...
        while (c.moveToNext()) {
            String path = c.getString(c
                    .getColumnIndex(DownloadPicturesTable.PATH));
            pathList.add(path);
        }
        ...
        String deleteSql = "delete from " + DownloadPicturesTable.TABLE_NAME
                + " where " + DownloadPicturesTable.PATH + " in (%s)";
