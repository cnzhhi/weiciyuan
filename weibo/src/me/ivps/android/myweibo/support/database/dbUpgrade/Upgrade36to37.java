package me.ivps.android.myweibo.support.database.dbUpgrade;

import java.io.File;

import me.ivps.android.myweibo.support.database.DatabaseHelper;
...
public class Upgrade36to37 {
    ...
    public static void upgrade(SQLiteDatabase db) {
        ...
        String thumbnailPath = FileManager.getSdCardPath() + File.separator
                + PICTURE_THUMBNAIL;
        String middlePath = FileManager.getSdCardPath() + File.separator
                + PICTURE_BMIDDLE;
        String oriPath = FileManager.getSdCardPath() + File.separator
                + PICTURE_LARGE;
        String largeAvatarPath = FileManager.getSdCardPath() + File.separator
                + AVATAR_LARGE;
        String smallAvatarPath = FileManager.getSdCardPath() + File.separator
                + AVATAR_SMAll;
