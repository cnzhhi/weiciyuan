package me.ivps.android.myweibo.support.database;

import me.ivps.android.myweibo.support.database.dbUpgrade.Upgrade35to36;
import me.ivps.android.myweibo.support.database.dbUpgrade.Upgrade36to37;
import me.ivps.android.myweibo.support.database.table.AccountTable;
import me.ivps.android.myweibo.support.database.table.AtUsersTable;
import me.ivps.android.myweibo.support.database.table.CommentByMeTable;
import me.ivps.android.myweibo.support.database.table.CommentsTable;
import me.ivps.android.myweibo.support.database.table.DMTable;
import me.ivps.android.myweibo.support.database.table.DownloadPicturesTable;
import me.ivps.android.myweibo.support.database.table.DraftTable;
import me.ivps.android.myweibo.support.database.table.EmotionsTable;
import me.ivps.android.myweibo.support.database.table.FavouriteTable;
import me.ivps.android.myweibo.support.database.table.FilterTable;
import me.ivps.android.myweibo.support.database.table.GroupTable;
import me.ivps.android.myweibo.support.database.table.HomeOtherGroupTable;
import me.ivps.android.myweibo.support.database.table.HomeTable;
import me.ivps.android.myweibo.support.database.table.MentionCommentsTable;
import me.ivps.android.myweibo.support.database.table.MyStatusTable;
import me.ivps.android.myweibo.support.database.table.NotificationTable;
import me.ivps.android.myweibo.support.database.table.RepostsTable;
import me.ivps.android.myweibo.support.database.table.TopicTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String CREATE_ACCOUNT_TABLE_SQL = "create table "
            ...
            + " integer primary key autoincrement," + AccountTable.OAUTH_TOKEN
            + " text," + AccountTable.OAUTH_TOKEN_EXPIRES_TIME + " text,"
    ...
    static final String CREATE_GROUP_TABLE_SQL = "create table "
            + GroupTable.TABLE_NAME + "(" + GroupTable.ID
            + " integer primary key autoincrement," + GroupTable.ACCOUNTID
            + " text," + GroupTable.JSONDATA + " text" + ");";
    
    static final String CREATE_HOME_TABLE_SQL = "create table "
            + HomeTable.TABLE_NAME + "(" + HomeTable.ID
            + " integer primary key autoincrement," + HomeTable.ACCOUNTID
            + " text," + HomeTable.TIMELINEDATA + " text,"
    ...
    static final String CREATE_HOME_OTHER_GROUP_TABLE_SQL = "create table "
            + HomeOtherGroupTable.TABLE_NAME + "(" + HomeOtherGroupTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_COMMENTS_TABLE_SQL = "create table "
            + CommentsTable.TABLE_NAME + "(" + CommentsTable.ID
            + " integer primary key autoincrement," + CommentsTable.ACCOUNTID
            + " text," + CommentsTable.TIMELINEDATA + " text" + ");";
    
    static final String CREATE_COMMENTS_DATA_TABLE_SQL = "create table "
            + CommentsTable.CommentsDataTable.TABLE_NAME + "("
            + CommentsTable.CommentsDataTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_REPOSTS_TABLE_SQL = "create table "
            + RepostsTable.TABLE_NAME + "(" + RepostsTable.ID
            + " integer primary key autoincrement," + RepostsTable.ACCOUNTID
            + " text," + RepostsTable.TIMELINEDATA + " text" + ");";
    ...
    static final String CREATE_COMMENT_BY_ME_TABLE_SQL = "create table "
            + CommentByMeTable.TABLE_NAME + "(" + CommentByMeTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_COMMENT_BY_ME_DATA_TABLE_SQL = "create table "
            ...
            + CommentByMeTable.CommentByMeDataTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_MENTION_COMMENTS_TABLE_SQL = "create table "
            + MentionCommentsTable.TABLE_NAME + "(" + MentionCommentsTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_MENTION_COMMENTS_DATA_TABLE_SQL = "create table "
            ...
            + " text,"
            + MentionCommentsTable.MentionCommentsDataTable.JSONDATA
            + " text" + ");";
    
    static final String CREATE_DMS_TABLE_SQL = "create table "
            + DMTable.TABLE_NAME + "(" + DMTable.ID
            + " integer primary key autoincrement," + DMTable.ACCOUNTID
            + " text," + DMTable.MBLOGID + " text," + DMTable.JSONDATA
            + " text" + ");";
    
    static final String CREATE_FAVOURITES_TABLE_SQL = "create table "
            + FavouriteTable.TABLE_NAME + "(" + FavouriteTable.ID
            + " integer primary key autoincrement," + FavouriteTable.ACCOUNTID
            + " text," + FavouriteTable.TIMELINEDATA + " text,"
    ...
    static final String CREATE_FAVOURITES_DATA_TABLE_SQL = "create table "
            ...
            + FavouriteTable.FavouriteDataTable.ID
            + " integer primary key autoincrement,"
    ...
    static final String CREATE_MYSTATUSES_TABLE_SQL = "create table "
            + MyStatusTable.TABLE_NAME + "(" + MyStatusTable.ID
            + " integer primary key autoincrement," + MyStatusTable.ACCOUNTID
            + " text," + MyStatusTable.TIMELINEDATA + " text" + ");";
    ...
    static final String CREATE_FILTER_TABLE_SQL = "create table "
            + FilterTable.TABLE_NAME + "(" + FilterTable.ID
            + " integer primary key autoincrement," + FilterTable.NAME
            + " text," + FilterTable.ACTIVE + " text," + FilterTable.TYPE
            + " integer" + ");";
    
    static final String CREATE_EMOTIONS_TABLE_SQL = "create table "
            + EmotionsTable.TABLE_NAME + "(" + EmotionsTable.ID
            + " integer primary key autoincrement," + EmotionsTable.JSONDATA
            + " text" + ");";
    
    static final String CREATE_DRAFTS_TABLE_SQL = "create table "
            + DraftTable.TABLE_NAME + "(" + DraftTable.ID
            + " integer primary key autoincrement," + DraftTable.ACCOUNTID
            + " text," + DraftTable.CONTENT + " text," + DraftTable.JSONDATA
            + " text," + DraftTable.PIC + " text," + DraftTable.GPS + " text,"
            + DraftTable.TYPE + " integer" + ");";
    
    public static final String CREATE_ATUSERS_TABLE_SQL = "create table "
            + AtUsersTable.TABLE_NAME + "(" + AtUsersTable.ID + " integer,"
            + AtUsersTable.USERID + " text," + AtUsersTable.ACCOUNTID
            + " text," + AtUsersTable.JSONDATA + " text," + "primary key ("
            + AtUsersTable.USERID + "," + AtUsersTable.ACCOUNTID + ")" + ");";
    
    static final String CREATE_TOPICS_TABLE_SQL = "create table "
            + TopicTable.TABLE_NAME + "(" + TopicTable.ID
            + " integer primary key autoincrement," + TopicTable.ACCOUNTID
            + " text," + TopicTable.TOPIC_NAME + " text" + ");";
    ...
    public static final String CREATE_DOWNLOAD_PICTURES_TABLE_SQL = "create table "
            ...
            + " text primary key,"
            + DownloadPicturesTable.PATH
            + " text,"
            + DownloadPicturesTable.SIZE
            + " integer,"
            + DownloadPicturesTable.TIME
            + " integer,"
            + DownloadPicturesTable.TYPE + " integer" + ");";
    
    private static final String CREATE_HOME_INDEX_SQL = "CREATE INDEX idx_"
            + HomeTable.HomeDataTable.TABLE_NAME + " ON "
            + HomeTable.HomeDataTable.TABLE_NAME + " ( "
    ...
    private static final String CREATE_DM_INDEX_SQL = "CREATE INDEX idx_"
            + DMTable.TABLE_NAME + " ON " + DMTable.TABLE_NAME + "("
            + DMTable.ACCOUNTID + ")";
    ...
    private static final String CREATE_NOTIFICATION_TABLE_SQL = "create table "
            + NotificationTable.TABLE_NAME + "(" + NotificationTable.ID
            + " integer ," + NotificationTable.ACCOUNTID + " text,"
            + NotificationTable.MSGID + " text," + NotificationTable.TYPE
            + " text," + "primary key (" + NotificationTable.ACCOUNTID + ","
            + NotificationTable.MSGID + "," + NotificationTable.TYPE + ")"
            + ");";
