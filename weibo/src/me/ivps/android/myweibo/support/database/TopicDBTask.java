...
public class TopicDBTask {
    ...
    public static void clear(String accountId) {
        String sql = "delete from " + TopicTable.TABLE_NAME + " where "
                + TopicTable.ACCOUNTID + " in " + "(" + accountId + ")";
    ...
    public static ArrayList<String> get(String accountId) {
        ...
        String sql = "select * from " + TopicTable.TABLE_NAME + " where "
                + TopicTable.ACCOUNTID + "  = " + accountId;
    ...
    public static void asyncReplace(final String accountId,
