package me.ivps.android.myweibo.support.imageutility;
...
public class ImageUtility {
    ...
    private static Bitmap getMiddlePictureInTimeLineGif(String filePath,
        ...
        try {
            ...
            Bitmap cornerBitmap = ImageEditUtility
    ...
    public static Bitmap getRoundedCornerPic(String url, int reqWidth,
            int reqHeight, FileLocationMethod method) throws WeiboException {
        ...
        try {
            ...
            if (file.exists()) {
                DisplayMetrics displayMetrics = GlobalContext.getInstance()
                        .getDisplayMetrics();
                return decodeBitmapFromSDCard(filePath,
                        displayMetrics.widthPixels, 900);
            }
            return null;
        }
        catch (OutOfMemoryError ignored) {
    ...
    public static Bitmap getWriteWeiboPictureThumblr(String filePath) {
        try {
            ...
            if (exifRotation != 0) {
                ...
                Bitmap adjustedBitmap = Bitmap.createBitmap(roundedBitmap, 0,
                        0, bitmap.getWidth(), bitmap.getHeight(), mtx, true);
