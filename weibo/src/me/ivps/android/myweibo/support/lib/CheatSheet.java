...
public class CheatSheet {
     ...
     */
    public static void setup(final Activity activity, View view,
            final int textResId) {
        view.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                return showCheatSheet(activity, view, view.getContext()
                        .getString(textResId));
            }
        });
    }
     ...
     */
    private static boolean showCheatSheet(Activity activity, View view,
            CharSequence text) {
