 ...
 *******************************************************************************/
package me.ivps.android.myweibo.support.lib.pulltorefresh.internal;

import me.ivps.android.myweibo.R;
import me.ivps.android.myweibo.support.lib.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements
    ...
    public final int getContentSize() {
        switch (mScrollDirection) {
            case HORIZONTAL:
                return mInnerLayout.getWidth() > 0 ? mInnerLayout.getWidth()
                        : Utility.dip2px(49);
            case VERTICAL:
            default:
                return mInnerLayout.getHeight() > 0 ? mInnerLayout.getHeight()
                        : Utility.dip2px(49);
        }
    }
