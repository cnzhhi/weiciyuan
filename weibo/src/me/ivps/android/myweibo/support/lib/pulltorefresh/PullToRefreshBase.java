 ...
 *******************************************************************************/
package me.ivps.android.myweibo.support.lib.pulltorefresh;

import me.ivps.android.myweibo.R;
import me.ivps.android.myweibo.support.lib.pulltorefresh.internal.LoadingLayout;
import me.ivps.android.myweibo.support.lib.pulltorefresh.internal.RotateLoadingLayout;
import me.ivps.android.myweibo.support.lib.pulltorefresh.internal.Utils;
import me.ivps.android.myweibo.support.lib.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
                ...
                if (mIsBeingDragged) {
                    ...
                    if (isRefreshing()) {
                        if (getRefreshableView() instanceof AdapterView) {
                            int count = 0;
                            Adapter adapter = ((AdapterView) getRefreshableView())
                                    .getAdapter();
                            if (adapter instanceof HeaderViewListAdapter) {
                                count = ((HeaderViewListAdapter) adapter)
    ...
    private void pullEvent() {
        ...
        if (getRefreshableView() instanceof AdapterView && isRefreshing()) {
            ...
            if (adapter instanceof HeaderViewListAdapter) {
                count = ((HeaderViewListAdapter) adapter).getWrappedAdapter()
                        .getCount();
            }
