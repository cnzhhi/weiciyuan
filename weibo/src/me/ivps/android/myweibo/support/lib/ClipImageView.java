...
public class ClipImageView extends GifImageView {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable == null
                || (clipVerticalPercent == 0 && clipHorizontalPercent == 0
                        && clipTopPercent == 0 && clipBottomPercent == 0
        ...
        clipRect.set(clipRect.left + clipH + clipLeft, clipRect.top + clipV
                + clipTop, clipRect.right - clipH - clipRight, clipRect.bottom
                - clipV - clipBottom);
