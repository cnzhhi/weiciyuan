...
public class ClearUnreadDao {
     ...
     * count
     */
    public boolean clearMentionStatusUnread(UnreadBean unreadBean,
            String accountId) throws WeiboException {
        int count = unreadBean.getMention_status();
        UnreadBean currentCount = new UnreadDao(access_token, accountId)
                .getCount();
        ...
        return new ClearUnreadDao(access_token, ClearUnreadDao.MENTION_STATUS)
                .clearUnread();
    }
    
    public boolean clearMentionCommentUnread(UnreadBean unreadBean,
            String accountId) throws WeiboException {
        ...
        return new ClearUnreadDao(access_token, ClearUnreadDao.MENTION_CMT)
                .clearUnread();
    }
    ...
    public boolean clearCommentUnread(UnreadBean unreadBean, String accountId)
        ...
        return new ClearUnreadDao(access_token, ClearUnreadDao.CMT)
                .clearUnread();
    }
