...
public class AnimationRect implements Parcelable {
    ...
    public static final Parcelable.Creator<AnimationRect> CREATOR = new Parcelable.Creator<AnimationRect>() {
        public AnimationRect createFromParcel(Parcel in) {
            ...
            rect.scaledBitmapRect = in.readParcelable(Rect.class
                    .getClassLoader());
            rect.imageViewEntireRect = in.readParcelable(Rect.class
                    .getClassLoader());
            rect.imageViewVisibleRect = in.readParcelable(Rect.class
                    .getClassLoader());
    ...
    public static AnimationRect buildFromImageView(ImageView imageView) {
        ...
        rect.thumbnailWidthHeightRatio = (float) bitmap.getWidth()
        ...
        rect.imageViewEntireRect.right = rect.imageViewEntireRect.left
                + imageView.getWidth();
        rect.imageViewEntireRect.bottom = rect.imageViewEntireRect.top
                + imageView.getHeight();
        
        rect.imageViewVisibleRect = new Rect();
        boolean isVisible = imageView
                .getGlobalVisibleRect(rect.imageViewVisibleRect);
        
        boolean checkWidth = rect.imageViewVisibleRect.width() < imageView
                .getWidth();
        boolean checkHeight = rect.imageViewVisibleRect.height() < imageView
                .getHeight();
        ...
        switch (scaledType) {
            case CENTER_CROP:
                ...
                scaledBitmapRect.set(scaledBitmapRect.left + deltaX,
                        scaledBitmapRect.top + deltaY, scaledBitmapRect.right
                                - deltaX, scaledBitmapRect.bottom - deltaY);
    ...
    public static float getClipLeft(AnimationRect animationRect,
            Rect finalBounds) {
        ...
        int thumbnailAndOriDeltaRightSize = Math
                .abs(animationRect.scaledBitmapRect.width()
        ...
        float deltaH = (float) (oriBitmapScaledWidth - oriBitmapScaledWidth
                * serverClipThumbnailRightSizePercent - animationRect.widgetWidth);
    ...
    public static float getClipTop(AnimationRect animationRect, Rect finalBounds) {
        ...
        int thumbnailAndOriDeltaBottomSize = Math
                .abs(animationRect.scaledBitmapRect.height()
        ...
        float deltaV = (float) (oriBitmapScaledHeight - oriBitmapScaledHeight
                * serverClipThumbnailBottomSizePercent - animationRect.widgetHeight);
    ...
    public static float getClipRight(AnimationRect animationRect,
            Rect finalBounds) {
        final Rect startBounds = animationRect.scaledBitmapRect;
    ...
    public static float getClipBottom(AnimationRect animationRect,
            Rect finalBounds) {
        final Rect startBounds = animationRect.scaledBitmapRect;
