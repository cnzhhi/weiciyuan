 ...
 */
public class ClickableTextViewMentionLinkOnTouchListener implements
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (find) {
                    LongClickableLinkMovementMethod.getInstance().onTouchEvent(
                            tv, value, event);
                    ...
                    // Android has a bug, sometime TextView wont change its
                    // value when you modify SpannableString,
