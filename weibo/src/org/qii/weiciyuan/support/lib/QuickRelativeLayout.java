...
public class QuickRelativeLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            switch (i) {
                ...
                case AVATAR_INDEX:
                    widthSpec = MeasureSpec.makeMeasureSpec(defaultWidth,
                            MeasureSpec.EXACTLY);
                    heightSpec = MeasureSpec.makeMeasureSpec(defaultHeight,
                            MeasureSpec.EXACTLY);
                    child.measure(widthSpec, heightSpec);
                    
                    avatarWidth = child.getMeasuredWidth() + lp.leftMargin
                            + lp.rightMargin;
                    avatarHeight = child.getMeasuredHeight() + lp.topMargin
                            + lp.bottomMargin;
                    ...
                    break;
                case COUNT_INDEX:
                    widthSpec = MeasureSpec.makeMeasureSpec(contentMaxWidth,
                            MeasureSpec.AT_MOST);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
                    
                    countWidth = child.getMeasuredWidth() + lp.leftMargin
                            + lp.rightMargin;
                    countHeight = child.getMeasuredHeight() + lp.topMargin
                            + lp.bottomMargin;
                    ...
                    break;
                case USERNAME_INDEX:
                    int childWidth = contentMaxWidth - avatarWidth - countWidth
                    ...
                    usernameWidth = child.getMeasuredWidth() + lp.leftMargin
                            + lp.rightMargin;
                    usernameHeight = child.getMeasuredHeight() + lp.topMargin
                            + lp.bottomMargin;
                    ...
                    break;
                case TIME_INDEX:
                    int timeChildMaxWidth = contentMaxWidth - avatarWidth
                            - lp.leftMargin - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(timeChildMaxWidth,
                            MeasureSpec.AT_MOST);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
                    
                    timeWidth = child.getMeasuredWidth() + lp.leftMargin
                            + lp.rightMargin;
                    timeHeight = child.getMeasuredHeight() + lp.topMargin
                            + lp.bottomMargin;
                    ...
                    break;
                case SOURCE_INDEX:
                    int sourceChildMaxWidth = contentMaxWidth - avatarWidth
                            - timeWidth - lp.leftMargin - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(
                            sourceChildMaxWidth, MeasureSpec.AT_MOST);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
                    
                    sourceWidth = child.getMeasuredWidth() + lp.leftMargin
                            + lp.rightMargin;
                    sourceHeight = child.getMeasuredHeight() + lp.topMargin
                            + lp.bottomMargin;
                    
                    lp.mLeft = paddingLeft + avatarWidth + timeWidth
                            + lp.leftMargin;
                    lp.mRight = lp.mLeft + child.getMeasuredWidth();
                    ...
                    break;
                case CONTENT_INDEX:
                    int contentChildMaxWidth = contentMaxWidth - lp.leftMargin
                            - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(
                            contentChildMaxWidth, MeasureSpec.EXACTLY);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
                ...
                case REPOST_CONTENT_INDEX:
                    int repostContentChildMaxWidth = contentMaxWidth
                            - lp.leftMargin - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(
                            repostContentChildMaxWidth, MeasureSpec.EXACTLY);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
                ...
                case REPOST_CONTENT_PIC_INDEX:
                    int repostContentPicChildMaxWidth = contentMaxWidth
                            - lp.leftMargin - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(
                            repostContentPicChildMaxWidth, MeasureSpec.EXACTLY);
                    heightSpec = MeasureSpec.makeMeasureSpec(defaultHeight,
                            MeasureSpec.EXACTLY);
                    child.measure(widthSpec, heightSpec);
                ...
                case REPOST_CONTENT_PIC_MULTI_INDEX:
                    int repostContentMultiPicChildMaxWidth = contentMaxWidth
                            - lp.leftMargin - lp.rightMargin;
                    widthSpec = MeasureSpec.makeMeasureSpec(
                            repostContentMultiPicChildMaxWidth,
                            MeasureSpec.EXACTLY);
                    heightSpec = MeasureSpec.makeMeasureSpec(0,
                            MeasureSpec.UNSPECIFIED);
                    child.measure(widthSpec, heightSpec);
    ...
    @Override
    public QuickRelativeLayout.LayoutParams generateLayoutParams(
            AttributeSet attrs) {
