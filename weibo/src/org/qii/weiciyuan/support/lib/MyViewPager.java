...
public class MyViewPager extends ViewPager {
    ...
    public void setGestureDetector(Activity activity,
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if ((ev.getActionMasked() == MotionEvent.ACTION_UP || ev
                .getActionMasked() == MotionEvent.ACTION_CANCEL)
            ...
            if (x > (Utility.getScreenWidth() / 2)) {
                ...
                this.topView.animate().translationX(0).setDuration(300L)
                        .withLayer().setListener(new AnimatorListenerAdapter() {
                            @Override
