 ...
 */
public class LocalOrNetworkChooseWorker extends
        AbstractWorker<String, Integer, Boolean> {
    ...
    public LocalOrNetworkChooseWorker(ImageView view, String url,
    ...
    protected Boolean doInBackground(String... url) {
        ...
        return ImageUtility.isThisBitmapCanRead(path)
                && TaskCache.isThisUrlTaskFinished(data);
    }
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result) {
            ...
            if (IWeiciyuanDrawable != null) {
                ...
                newTask = new LocalWorker(imageView, getUrl(), method,
                        isMultiPictures);
                PictureBitmapDrawable downloadedDrawable = new PictureBitmapDrawable(
                        newTask);
            ...
            if (IWeiciyuanDrawable != null) {
                ...
                newTask = new ReadWorker(imageView, getUrl(), method,
                        isMultiPictures);
                PictureBitmapDrawable downloadedDrawable = new PictureBitmapDrawable(
                        newTask);
                imageView.setImageDrawable(downloadedDrawable);
